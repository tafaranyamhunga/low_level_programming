...
- [ ] `O_WRONLY | 0_CREAT | O_EXCL`

- [ ] `O_RDWR | 0_CREAT | O_APPEND`

- [ ] `O_WRONLY | 0_CREAT | O_APPEND`
...
- [ ] Because this will be the first opened file descriptor and we start counting from`1`
...
When I am using `O_WRONLY | 0_CREAT | O_APPEND` -> the | are bitwise operators?
