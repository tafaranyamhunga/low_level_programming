...
![Singly Linked Lists](./assets/gifs/giphy-3.gif)
...
Arrays Vs Linked Lists: select all the true statements

- [ ] We can add elements indefinitely to an array

- [ ] We can easily remove an element from a Linked List

- [ ] Memory is aligned for a Linked List - each elements are back to in the memory
...
- [ ] Memory is aligned for an array - each elements are back to in the memory
...
![The hare and the tortoise](./assets/images/the-hare-and-the-tortoise.jpeg)
