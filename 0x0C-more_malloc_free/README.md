...
int main(void)
{
    ...
    i = malloc_checked(sizeof(int) * 1024);
    printf("%p\n", (void *)i);
...
$ julien@ubuntu:~/0x0b. more malloc, free$ gcc -Wall -pedantic -Werror -Wextra -std=gnu89 0-main.c 0-malloc_checked.c -0 a
...
$ julien@ubuntu:~/0x0b. more malloc, free$ gcc -Wall -pedantic -Werror -Wextra 1-main.c 1-string_nconcat.c -o 1-string_nconcat
...
$ julien@ubuntu:~/0x0b. more malloc, free$ gcc -Wall -pedantic -Werror -Wextra 2-main.c 2-calloc.c -o 2-calloc
...
$ amonkeyprogrammer@ubuntu:~/0x0b. more malloc, free$ gcc -Wall -pedantic -Werror -Wextra 3-main.c 3-array_range.c -o 3-array_range
$ amonkeyprogrammer@ubuntu:~/0x0b. more malloc, free$ ./array_range
