...
![A dog seated weirdly with a macbook](./assets/images/dynamic-memory-allocation.jpeg)
...
struct tag_name {
    type member1;
    type member2;
    /* declare as many members as declared, but the entire structure size must be known to the compiler*/
};
```
...
struct point *p = &any_point;
```

To set the member `y` of variable `my_point` to `98`, I can do (select all valid answers):
...
You should write documentation for all structures you create

- [ ] As soon as I write my structure

- [ ] True

- [ ] I'll do it 5 minutes before deadline when I try Betty on my header file
...
![Task 2](./assets/images/task-2.webp)
...
![Task 3](./assets/images/task-3.jpeg)
...
![Task 4](./assets/images/task-4.jpg)
...
![Task 5](./assets/images/task-5.jpg)
