...
![Happy clapping gif](./assets/gifs/happy-clapping.gif)
...
What happens when one tries to derefence a pointer to NULL?
...
- [ ] The first one can be derefenced, not the second one

- [ ] The second one can be derefenced, not the first one

- [ ] The first one points to 0-byte, the second one points to a 0
...
- [ ] The `array` is not entirely initialized
