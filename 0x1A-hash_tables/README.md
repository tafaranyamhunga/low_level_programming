...
- [All about hash tables](https://alx-intranet.hbtn.io/rltoken/mxjKpEfAw3E5B8S3inPuHQ)
- [Why hash tables and not arrays](https://alx-intranet.hbtn.io/rltoken/mxjKpEfAw3E5B8S3inPuHQ)
...
In [PHP](https://www.phpinternalsbook.com/php5/hashtables.html), hash tables are **ordered**. Wait... WAT? How is this even possible?

![Wait what?](./assets/gifs/dog-what-fuck-all.gif)

**Before you continue**, please take a moment to think about it: how you would implement it if you were asked to during an interview or a job. What data structures would you use? How would it work?

For this task, please:

- Read [PHP Internals Book: HashTable](https://www.phpinternalsbook.com/php5/hashtables.html)
